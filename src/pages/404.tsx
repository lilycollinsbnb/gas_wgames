...
const ErrorPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Seo
        title="Godot Asset Store - 404 Error"
        description="Godot Asset Store"
        url="/404"
      />
      <div className="flex h-full items-center justify-center p-4 md:p-6 xl:p-8">
        <div className="max-w-md text-center xl:max-w-lg">
          ...
          >
            <AssetsIcon className="h-[18px] w-[18px] text-dark/40 group-hover:text-brand dark:text-light/60" />{' '}
            {t('404-back-home')}
          </AnchorLink>
        </div>
      </div>
