...
const RedeemAccessPage: NextPageWithLayout = () => {
...
RedeemAccessPage.authorization = true
RedeemAccessPage.getLayout = function getLayout(page) {
...
export default RedeemAccessPage
