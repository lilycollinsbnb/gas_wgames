...
import { PLFlag } from '@/components/icons/flags/PLFlag';
...
import { PLFlagRound } from '@/components/icons/flags/PLFlagRound';
...
export let languageMenu = [
  ...
  },
  {
    ...
    name: 'Polski',
    value: 'pl',
    icon: <PLFlag width="20px" height='15px' />,
    iconMobile: <PLFlagRound />
  }
];
