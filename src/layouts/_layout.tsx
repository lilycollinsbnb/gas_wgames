...
export default function Layout({ children }: React.PropsWithChildren<{}>) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const storedCollapse = localStorage.getItem('sidebarCollapse')
      if (storedCollapse !== null) {
        setCollapse(storedCollapse === 'true')
      }
    }
  }, [])
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      localStorage.setItem('sidebarCollapse', String(collapse))
    }
  }, [collapse])
  return (
    <motion.div
      ...
      <div className="flex flex-1">
        ...
        <main
          className={cn(
            ...
            collapse
              ? 'sm:pl-[90px] ltr:xl:pl-[75px] rtl:xl:pr-[75px]' // Adjust padding for smaller screens
              : 'sm:pl-[190px] lg:pl-[200px] xl:pl-[160px] ltr:xl:pl-60 rtl:xl:pr-60' // Adjust padding for expanded sidebar
          )}
        >
          {children}
        </main>
