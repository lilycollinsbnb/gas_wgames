...
const AboutPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Seo
        title="About us - Empowering Developers with Quality Godot Game Assets"
        description="Learn more about the Assets 4 Godot Store, our mission to provide high-quality premium assets, and how we support the Godot community. Discover our commitment to helping developers bring their projects to life."
        url={routes.about}
      />
